   ...
   <div class=zeroappdetails >
    <div class="appdetails">
        <div style="display: flex; justify-content: flex-end;" >
            <button style="border: 1px solid black; color: black; width: 45px; border-radius: 5px; background-color: #fca5a5; position: absolute;" @click="Exit">
                X
            </button>
        </div>
        ...
        <div class="appdetails2">
            <div class="appdetails3">
                <input class="inputall" placeholder="Application Number"/>
            ...
            <div class="appdetails4" >
                ...
                <input class="inputall" v-model="contactnum" @input="formatContactNum" maxlength="11" required placeholder="Contact Number"/>
